        ...
        <div >
            <div className='w-10/12 mx-auto justify-between flex items-center mt-4'>
                ...
                <div className='flex items-center space-x-6'>
                    ...
                    <div className='flex items-center border border-primary text-primary p-3 rounded-3xl gap-1 cursor-pointer hover:bg-gray-200'>Sort by price <FaSortAmountDown /></div>
                    <div className='border px-8 rounded-3xl bg-primary text-white btn'>Purchase</div>
                </div>
            </div>
            <div className='mt-6'>
                {
                    cart.length > 0 ? (cart.map(item => <CartCard removeCartItem={removeCartItem} item={item}></CartCard>))
                        : (<div className='w-10/12 p-24 mx-auto border text-center space-y-4'>
